...
export default function NewGoalDashboard({ calendarStats, goals, events, startDate, endDate, setDataVersion }) {
    ...
    return (
        <Box>
            <Box mb={4} display="flex" justifyContent="space-between" alignItems="center">
                            ...
                            <AddNewGoal calendars={calendarStats} setDataVersion={setDataVersion}/>
                        </Box>
                    ...
                    <Grid item xs={12} md={6} lg={4} key={goal.id || index}>
                        ...
                        >
                            <CardHeader
                                ...
                                action={
                                    <AddNewGoal calendars={calendarStats} selectedCalendarProp={goal.calendarId} goalHoursProp={goal.targetHours} timeframeProp={goal.timeframe} goalId={goal.id} calendarNameProp={goal.calendarName} setDataVersion={setDataVersion}/>
                                }
